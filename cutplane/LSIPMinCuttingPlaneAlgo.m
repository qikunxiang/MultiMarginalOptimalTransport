            ...
            while true
                ...
                while true
                    ...
                    if LP_trial_num == 1
                        ...
                        % time limit without converging), retry after 
                        % setting higher numeric focus, turning off
                        % presolve, and removing the existing bases 
                        LP_options_runtime.TimeLimit = ...
                            LP_options.TimeLimit * 2;
                        ...
                        if isfield(obj.Runtime.CurrentLPModel, 'cbasis')
                            obj.Runtime.CurrentLPModel = ...
                                rmfield(obj.Runtime.CurrentLPModel, ...
                                'cbasis');
                        end
