function CONFIG = CPWAMM_config()
% Place to store global configurations of the CPWA example
% Output:
...
% path to save files
CONFIG.SAVEPATH = [CONFIG.SAVEPATH_ROOT, 'MMOT/CPWACost_Exp/'];

% path to log files
CONFIG.LOGPATH = [CONFIG.LOGPATH_ROOT, 'MMOT/CPWACost_Exp/'];
...
CONFIG.LOGPATH_LSIP_GLOBAL = [CONFIG.LOGPATH_GUROBI, CONFIG.LOGNAME_LSIP_GLOBAL, '.log'];
