...
COMPARISONS_XLIM = [-0.2, COMPARISONS_TOTAL_COLUMN_NUM + 0.6];
COMPARISONS_YLIM = {
    [-0.370, 0.220], ...
    [-0.370, 0.220]
};
...
figure('Position', [0, 0, 450, 500]);
ha = tight_subplot(2, 1, [0.006, 0], [0.035, 0.040], [0.110, 0.008]);
for arr_id = 1:length(arrangements)
    axes(ha(arr_id));
