...
for arr_id = 1:length(arrangements)
    ...
    OT = MMOT1DFluid(timestep_num_list(plot_timestep_num_index), arrangements{arr_id}, ...
        testfunc_knot_num_list(plot_testfunc_num_index));

    OT.setLSIPSolutions(LSIP_primal_cell{arr_id}{plot_timestep_num_index, plot_testfunc_num_index}, ...
        LSIP_dual_cell{arr_id}{plot_timestep_num_index, plot_testfunc_num_index}, ...
        LSIP_UB_cell{arr_id}(plot_timestep_num_index, plot_testfunc_num_index), ...
        LSIP_LB_cell{arr_id}(plot_timestep_num_index, plot_testfunc_num_index));
    OT.setComonotoneMap(OT_comonotone_map_cell{arr_id}{plot_timestep_num_index, plot_testfunc_num_index});
