...
CONFIG.SAVEPATH = [CONFIG.SAVEPATH_ROOT, ...
    'MMOT/WassersteinBarycenter_Exp/'];
...
CONFIG.SAVEPATH_W2OT = ...
    [CONFIG.SAVEPATH, CONFIG.FILENAME_W2OT, '.mat'];
...
CONFIG.SAVEPATH_UB = ...
    [CONFIG.SAVEPATH, CONFIG.FILENAME_UB, '.mat'];

% file name of the Wasserstein-2 optimal transport based upper bounds
CONFIG.FILENAME_W2OTUB = 'W2OTUB';
CONFIG.SAVEPATH_W2OTUB = ...
    [CONFIG.SAVEPATH, CONFIG.FILENAME_W2OTUB, '.mat'];
...
CONFIG.LOGPATH_W2OT = ...
    [CONFIG.LOGPATH, CONFIG.LOGNAME_W2OT, '.log'];
...
CONFIG.LOGPATH_W2OTUB = ...
    [CONFIG.LOGPATH, CONFIG.LOGNAME_W2OTUB, '.log'];
