...
FILE_PREFIX = 'exp/MMOT/Comparisons/Saved/WassersteinBarycenter/RKHS/';
FILE_SUFFIX = '_exp.json';
FILE_NAMES_CELL = {
    'L2_25000_Laplace_8.0', ...
    'L2_50000_Laplace_8.0', ...
    'L2_100000_Laplace_8.0'
};



figure('Position', [200, 100, 700, 1200]);
