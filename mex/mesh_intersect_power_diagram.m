...
% /// For generating a MATLAB function: [output_vertices, output_triangulation, power_cell_indices, mesh_indices] = mesh_intersect_power_diagram(mesh_vertices, mesh_triangulation, circle_centers, circle_radii, bbox_bottom_left, bbox_top_right)
