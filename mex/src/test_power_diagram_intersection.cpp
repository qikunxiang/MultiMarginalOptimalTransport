...
int main(int argc, char* argv[])
{
    ...
    std::vector<Point_2> centroids = compute_power_diagram_intersection(segments);
    ...
    for (size_t set_id = 0; set_id < set_num; ++set_id)
    {
        ...
        std::vector<size_t> set_cell_indices = compute_power_diagram_cell_indices(centroids, circle_sets[set_id]);

        centroid_cell_indices[set_id] = set_cell_indices;
    }
